...
import AdminDisplayOrders from './AdminDisplayOrders/AdminDisplayOrders'
...
export default function AdminOrders() {
    ...
    return (
        <div className="order-container">
            ...
            <p>Here You can edit available orders and add new orders</p>
                    ...
                    <tbody>
                        {
                            orders.map((order, index) =>
                                <AdminDisplayOrders order={order}
            ...
            <Link to='/admin/orders' className='btn btn-primary mr-5 mt-5 mb-5'
