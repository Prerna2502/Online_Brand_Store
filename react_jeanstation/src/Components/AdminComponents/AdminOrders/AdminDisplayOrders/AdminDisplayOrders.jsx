...
export default function AdminDisplayOrders(props) {
    const DeleteHandler = () => {
    ...
    return (
        <tr>
            ...
            <td><Link to='/admin/orders' className='btn btn-primary' onClick={UpdateStatusHandler}>Edit Status</Link></td>
            <td><Link to='/admin/orders' className='btn btn-primary' onClick={UpdateHandler}>Edit Order</Link></td>
            <td><Link to='/admin/orders' className='btn btn-primary' onClick={DeleteHandler}>Delete</Link></td>
        </tr>
    )
}
